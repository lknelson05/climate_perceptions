...
##Makes likert plots for questions regarding how people think ocean warming will affect fisheries
##plots saved to ../figures/species_change
...
```{r load data}
#need to load data file that still has original, untransformed answers 
