...
```
##Section 1. Creating the new measure of adaptive capacity.
...
#this needs to be done but this doens't work, it erases everything else in the column
Consoldating fishery categories for the few random things that people wrote
```{r}
domainsmod<- domainsmod %>%
  mutate(fisheries = case_when(
