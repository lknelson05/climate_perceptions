...
Separate all the fisheries in their own column and saving for Mary to help build networks. see building networks code for how to clean this up and use it.
```{r}
