...
ac_barnes<-responses%>%
  select(money, vessel_owner, loan, income, other_fisheries, num_fisheries, vessel, yrs_fishing, age, effective_mgmt, equitable, adapt_mgmt, connect_env, connect_comm, strong_comm, generation, harm_me, harm_future, voice, const_reg, no_point)
