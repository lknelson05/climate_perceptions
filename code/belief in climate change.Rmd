...
```
#load data
#chose which region you want to run
...
#use appropriate test depending on what meets assumptions of anova
```{r}
#anova
...
shapiro.test(x = aov_residuals )
```
#rideline plots of belief and components of vulnerability
```{r}
