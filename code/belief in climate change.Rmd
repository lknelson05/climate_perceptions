...
responses <- read.csv("../data/BC_decoded_vulnerability.csv")
```
...
pu<-ggplot(responses, aes(x = indv_vulnerability_euc, group = believecat, fill = believecat))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 3)) +
  geom_vline(xintercept = 1.088, color = "#0f85a0") +
  geom_vline(xintercept = 1.005, color = "#dd4124") +
  geom_vline(xintercept = 1.108, color = "#edd746") +
    ggtitle("Distribution of perceived vulnerability")+ 
...
ggsave(plot = harm_vuln, file = paste0("../figures/vulnerability/harm_vuln.png"))
...
#is there a difference in the mean vulnerability of the agree belive group and the will be harmed group?
aa<- responses %>%
