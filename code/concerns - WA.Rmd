...
##Examines how concerns compare for a variety of issues that may affect fishing success and wellbeing
##Clusters indviduals based upon their concern levels across six themes
##Saves figures to ../figures/wellbeing
...
ggsave(plot = worry_cor_plot, file = paste0("../figures/WA/worry_cor.png"))
...
ggsave(plot = concern_themes_plot, file = paste0("../figures/WA/concern_themes_cor.png"))
```
...
ggsave(plot = concerns_pca_plot, file = paste0("../figures/WA/concern_pca_final.png"))
...
ggsave(plot = concerns_scree, file = paste0("../figures/WA/concern_scree_final.png"))

ggsave(plot = concerns_variables, file = paste0("../figures/WA/concern_variable_final.png"))
...
ggsave(plot = concerns_rsc_pca_plot, file = paste0("../figures/WA/concern_rsc_pca.png"))
...
ggsave(plot = concerns_rsc_scree, file = paste0("../figures/WA/concern_rsc_scree.png"))

ggsave(plot = concerns_rsc_variables, file = paste0("../figures/WA/concern_rsc_variable.png"))
```
...
ggsave(plot = cbc_plot, height = 7, width = 10, file = paste0("../figures/WA/concern_3_cluster.png"))

ggsave(plot = cbc_plot, height = 7, width = 10, dpi = 500, file = paste0("../figures/WA/concern_3_cluster.tiff"))
```
...
ggsave(plot = cbc_plot, file = paste0("../figures/WA/concern_by_cluster3.png"))
```
