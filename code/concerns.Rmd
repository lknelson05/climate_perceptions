...
test.concern.pca<-prcomp(concern_scores)
...
cbc_plot<-ggplot(cbc_long, aes(x=groups, y = value, fill = groups)) + geom_boxplot()+
  ...
  scale_fill_manual(values = pnw_palette(n=2, name = "Bay"))

cbc_plot

ggsave(plot = cbc_plot, file = paste0("../figures/wellbeing/concern_rsc_by_cluster.png"))
```
...
#cluster
NbClust(concern_scores_om, distance = "euclidean", min.nc = 2, max.nc = 10, method = "complete", index = "alllong")
