...
```{r load data}
responses <- read_excel("../data/BC_Data100220.xlsx")
```
...
responses <- responses %>%  
  rename(salmon_troll = Q2r13,
        salmon_seine = Q2r14,
        salmon_gillnet =	Q2r15,
        herring_roe_gillnet =	Q2r16,
        herring_roe_seine =	Q2r17,
        herring_spawn_on_kelp =	Q2r18,
        tuna_troll =	Q2r19,
        tuna_international =	Q2r20,
        tuna_us =	Q2r21,
        hake_midtrawl =	Q2r22,
        sardine =	Q2r23,
        groundfish_trawl =	Q2r24,
        halibut_longline =	Q2r25,
        sablefish_longline =	Q2r26,
        sablefish_trap =	Q2r27,
        rockfish_hl =	Q2r28,
        lingcod_hl =	Q2r29,
        dogfish_hl =	Q2r30,
        shrimp_trawl	= Q2r31,
        euphausiid_trawl =	Q2r32,
        prawn_shrimp_trap =	Q2r33,
        crab_trap =	Q2r34,
        geoduck_horseclam_dive =	Q2r35,
        redseaurchin_dive =	Q2r36,
        greenseaurchin_dive =	Q2r37,
        seacucumber_dive =	Q2r38,
        other =	Q2r39)
```
...
responses <- responses %>% 
  mutate(lob_warming = sapply(X=responses$lob_warming, FUN=warm_cat),
         lob_warming_conf = sapply(X=responses$lob_warming_conf, FUN=conf_cat),
         ...
         men_warming = sapply(X=responses$men_warming, FUN=warm_cat),
         men_warming_conf = sapply(X=responses$men_warming_conf, FUN=conf_cat),
         
         sclp_warming = sapply(X=responses$sclp_warming, FUN=warm_cat),
         sclp_warming_conf = sapply(X=responses$sclp_warming_conf, FUN=conf_cat),
         
         cod_warming = sapply(X=responses$cod_warming, FUN=warm_cat),
         cod_warming_conf = sapply(X=responses$cod_warming_conf, FUN=conf_cat),
         
         hadk_warming = sapply(X=responses$hadk_warming, FUN=warm_cat),
         hadk_warming_conf = sapply(X=responses$hadk_warming_conf, FUN=conf_cat),

         polk_warming = sapply(X=responses$polk_warming, FUN=warm_cat),
         polk_warming_conf = sapply(X=responses$polk_warming_conf, FUN=conf_cat),
        
         halbt_warming = sapply(X=responses$halbt_warming, FUN=warm_cat),
         halbt_warming_conf = sapply(X=responses$halbt_warming_conf, FUN=conf_cat),
         
         wht_hake_warming = sapply(X=responses$wht_hake_warming, FUN=warm_cat),
         wht_hake_warming_conf = sapply(X=responses$wht_hake_warming_conf, FUN=conf_cat),
         
         dabs_warming = sapply(X=responses$dabs_warming, FUN=warm_cat),
         dabs_warming_conf = sapply(X=responses$dabs_warming_conf, FUN=conf_cat),
         
         gry_sole_warming = sapply(X=responses$gry_sole_warming, FUN=warm_cat),
         gry_sole_warming_conf = sapply(X=responses$gry_sole_warming_conf, FUN=conf_cat),
         
         windowpane_warming = sapply(X=responses$windowpane_warming, FUN=warm_cat),
         windowpane_warming_conf = sapply(X=responses$windowpane_warming_conf, FUN=conf_cat),
 
         yellowtail_warming = sapply(X=responses$yellowtail_warming, FUN=warm_cat),
         yellowtail_warming_conf = sapply(X=responses$yellowtail_warming_conf, FUN=conf_cat),
         
         wnt_flnder_warming = sapply(X=responses$wnt_flnder_warming, FUN=warm_cat),
         wnt_flnder_warming_conf = sapply(X=responses$wnt_flnder_warming_conf, FUN=conf_cat),
         
         redfish_warming = sapply(X=responses$redfish_warming, FUN=warm_cat),
         redfish_warming_conf = sapply(X=responses$redfish_warming_conf, FUN=conf_cat),
         
         monkfish_warming = sapply(X=responses$monkfish_warming, FUN=warm_cat),
         monkfish_warming_conf = sapply(X=responses$monkfish_warming_conf, FUN=conf_cat),
         
         skates_warming = sapply(X=responses$skates_warming, FUN=warm_cat),
         skates_warming_conf = sapply(X=responses$skates_warming_conf, FUN=conf_cat),
 
         whiting_warming = sapply(X=responses$whiting_warming, FUN=warm_cat),
         whiting_warming_conf = sapply(X=responses$whiting_warming_conf, FUN=conf_cat),
         
         red_hake_warming = sapply(X=responses$red_hake_warming, FUN=warm_cat),
         red_hake_warming_conf = sapply(X=responses$red_hake_warming_conf, FUN=conf_cat),
         
         red_crab_warming = sapply(X=responses$red_crab_warming, FUN=warm_cat),
         red_crab_warming_conf = sapply(X=responses$red_crab_warming_conf, FUN=conf_cat),
         
         clams_warming = sapply(X=responses$clams_warming, FUN=warm_cat),
         clams_warming_conf = sapply(X=responses$clams_warming_conf, FUN=conf_cat),
         ...
         summer_flnder_warming = sapply(X=responses$summer_flnder_warming, FUN=warm_cat), 
         summer_flnder_warming_conf = sapply(X=responses$summer_flnder_warming_conf, FUN=conf_cat),  
         
         scup_warming = sapply(X=responses$scup_warming, FUN=warm_cat),
         scup_warming_conf = sapply(X=responses$scup_warming_conf, FUN=conf_cat),
         
         black_seabass_warming = sapply(X=responses$black_seabass_warming, FUN=warm_cat),
         black_seabass_warming_conf = sapply(X=responses$black_seabass_warming_conf, FUN=conf_cat),
...
responses <- responses %>%    
   mutate(pop_size_concern = sapply(X=responses$pop_size_concern, FUN=concern_cat),
          ...
          osw_concern = sapply(X=responses$osw_concern, FUN=concern_cat),                          
          aqua_concern = sapply(X=responses$aqua_concern, FUN=concern_cat))                          
...
responses <- responses %>% 
  mutate(think_pop_size = sapply(X=responses$think_pop_size, FUN=thinking_cat),
         ...
         think_osw = sapply(X=responses$think_osw, FUN=thinking_cat),                               
         think_aqua = sapply(X=responses$think_aqua, FUN=thinking_cat))                              
...
responses <- responses %>% 
  mutate(graying_fleet_concern = sapply(X=responses$graying_fleet_concern, FUN=concern_cat),
         ...
         workforce_concern = sapply(X=responses$infrastructure_concern, FUN=concern_cat))
...
responses <- responses %>% 
    mutate(think_graying_fleet = sapply(X=responses$think_graying_fleet, FUN=thinking_cat), 
           ...
           think_workforce = sapply(X=responses$think_workforce, FUN=thinking_cat))                         
...
responses <- responses %>% 
  mutate(phsy_health_concern = sapply(X=responses$phsy_health_concern, FUN=concern_cat),
         ...
         finance_concern = sapply(X=responses$finance_concern, FUN=concern_cat))
...
responses <- responses %>%
  mutate(think_phsy_health = sapply(X=responses$think_phsy_health, FUN=thinking_cat),    
         ...
         think_finance = sapply(X=responses$think_finance, FUN=thinking_cat))                                   
...
responses <- responses %>% 
  mutate(recreational = sapply(X=responses$recreational, FUN=agree_cat),
         ...
         osw = sapply(X=responses$osw, FUN=agree_cat))
```
