...
##Makes a variety of likert and bar plots for survey questions regarding fisher wellbeing
...
ggsave(plot = ocean_concerns_likert, file = paste0("../figures/WA/ocean_concerns.png"))
```
...
ggsave(plot = fishing_concerns_plot, file = paste0("../figures/WA/fishing_concerns.png"))
```
...
ggsave(plot = community_concerns_plot, file = paste0("../figures/WA/community_concerns.png"))
```
...
ggsave(plot = total_concerns_likert, file = paste0("../figures/WA/all_concerns.png"))
...
ggsave(plot = climate_perspectives, height = 7, width = 10, dpi = 500, file = paste0("../figures/WA/climate_perspectives_hrt.tiff"))
...
ggsave(plot = conflict_plot, height = 7, width = 10, file = paste0("../figures/WA/conflict_plot.png"))
...
ggsave(plot = conflict_states_plot, height = 12, width = 10, file = paste0("../figures/WA/conflict_state.png"))
...
ggsave(plot = health_wellbeing_plot, height=7, width=10, file = paste0("../figures/WA/health_wellbeing_plot.png"))

#by state
health_states<-likert(q39, grouping = responses$state_code)
health_states_plot<-plot(health_states, colors=c('orange','darkorange', "gray", 'darkblue','blue')) + ggtitle(health_wellbeing_title)+ theme(axis.text = element_text(size = 12))

ggsave(plot = health_states_plot, height = 12, width = 10, file = paste0("../figures/WA/health_state.png"))
```
...
ggsave(plot = connections_plot, height=7, width=10, file = paste0("../figures/WA/connections_plot.png"))
```
...
ggsave(plot = capabilities_plot, height=7, width=10, file = paste0("../figures/WA/capabilities_plot.png"))
```
...
ggsave(plot = crosscutting_plot, height=7, width=10, file = paste0("../figures/WA/crosscutting_plot.png"))
```
...
ggsave(plot = ac_likert_plot, height=7, width=10, file = paste0("../figures/WA/ac_likert_plot.png"))
...
ggsave(plot = ac_states_plot, height = 12, width = 10, file = paste0("../figures/WA/ac_state.png"))
```

##select concerns for presentation
```{r}
some_concerns<-responses %>%
  select(warming_concern, sea_level_concern,  algal_concern, habitat_concern, oa_concern, pop_size_concern, bycatch_concern, costs_concern, reg_concern, safe_at_sea_concern)
...
ggsave(plot = tnc_concerns_likert, file = paste0("../figures/WA/tnc_concerns.png"))
...
ggsave(plot = ac_likert_plot, height=5, width=7, file = paste0("../figures/WA/ac_paper_plot2.png"))
...
ggsave(plot = ac_region_plot, height = 8, width = 8, file = paste0("../figures/WA/ac_state2.png"))

travelfeeling<-table(old_responses$region, old_responses$distance)
chisq.test(travelfeeling)

mosaicplot(travelfeeling, shade = TRUE, las = 2, main = "travel")

#by state

ac_state<-likert(ac, grouping = old_responses$state_code)
ac_state_plot<-plot(ac_state, colors=rev(pnw_palette("Sailboat", 5))) + ggtitle(ac_likert_title)+ theme(axis.text = element_text(size = 12))
...
ggsave(plot = travel_likert_plot, height=7, width=10, file = paste0("../figures/WA/travel_plot.png"))
...
ggsave(plot = travel_region_plot, height = 5, width = 7.5, file = paste0("../figures/WA/ac_travel.png"))
```

#doing ac a bit different for defense
```{r question 43}
#q43 plotting using likert package
#adapative capacity indicators
