...
processing <- ggplot(data = responses, aes(x=processing_concern))+
  geom_bar(stat = "count", fill = c("light blue", "navy blue", "purple"))+
   ylim(0, 90)+
  theme(axis.title.x = element_blank(), axis.title.y = element_blank(), axis.text.x = element_text(angle = 45))+
  ggtitle("Adequate local processing facilities")
...
ggsave(plot = connections_plot, file = paste0("../figures/wellbeing/connections_plot.png"))
```
...
ggsave(plot = capabilities_plot, file = paste0("../figures/wellbeing/capabilities_plot.png"))
```
...
ggsave(plot = crosscutting_plot, file = paste0("../figures/wellbeing/crosscutting_plot.png"))
```
...
ggsave(plot = ac_likert_plot, file = paste0("../figures/wellbeing/ac_likert_plot.png"))
```